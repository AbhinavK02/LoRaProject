...
To solve this problem, we introduce \href{https://github.com/AbhinavK02/LoRaProject}{\textbf{The Talking Mailbox}}. The aim of The Talking Mailbox project is to design and assemble a system that can detect the presence of mail within a mailbox in Building~06 and notify the owner of the mailbox.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
