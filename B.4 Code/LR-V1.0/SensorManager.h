 ...
 * @return A SensorReading struct containing the weight sensor's data.
 */
SensorReading readWeightSensor();

/**
 * @brief Reads the Digital Light Sensor.
 * @return A SensorReading struct containing the light sensor's data.
 */
SensorReading readLightSensor();

/**
 * @brief Reads the Digital Light Sensor.
 * @return A SensorReading struct containing the tilt sensor's data.
 */
SensorReading readTiltSensor();

/**
 * @brief Reads the Level of the Battery
 * @return A SensorReading struct containing the battery monitor data.
 */
