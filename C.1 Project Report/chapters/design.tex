...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[height=4.5cm]{weight-sensor_construction-2.jpg}
        \caption{Fully Assembled Load Cell Platform}
